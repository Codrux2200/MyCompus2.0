...
import { StyleSheet, Text, View, useWindowDimensions, Image, TouchableOpacity, TextInput, ScrollView} from 'react-native';
...
export const AddAnnoncesModal = () => {
    ...
    return(
        ...
        <View style = {{backgroundColor : 'white', height : "80%", borderRadius : 30}}>
            ...
            <Text style = {{textAlign : 'center', fontWeight : 'bold', fontSize : 50, marginBottom : 30}}>Ajouter une annonces</Text>
            ...
            <Text style = {{fontWeight : 'bold', fontSize : 30, marginBottom : 20}}>Sous-Titre</Text>
            <TextInput onChangeText= {(text) => {setsoustitle(text)}} style = {{borderBottomWidth : '0.5', width : 200, marginBottom : 40}}></TextInput>
        ...
        backgroundColor : "rgba(93, 95, 239, 1)"}}>
                <Text style = {{textAlign : 'center', fontWeight : 'bold', color : 'white'}}>Publier l'annonce</Text>
            </TouchableOpacity>
            </ScrollView>
            </View>
